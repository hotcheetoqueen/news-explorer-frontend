                    ...
                    <div className='news-card__image-container'>
                        <div className='news-card__save-container'>
                            ...
                            <button className='news-card__save'>
                                <img className='news-card__save-icon' src={NewsCardSaveIcon} />
                            </button>
                        </div>
                        <img className='news-card__photo' src='https://images.unsplash.com/photo-1612392062631-94dd858cba88?ixid=MXwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80' />
                    </div>
