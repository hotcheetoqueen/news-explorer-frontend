    ...
    return (
        ...
        <footer className='footer'>
            ...
            <ul className='footer__navigation'>
                <li className='footer__navigation_stacked'>
                    <div className='footer__navigation-item footer__navigation-item_text'><a className='footer__navigation-item-link' href='/'>Home</a></div>
                    <div className='footer__navigation-item footer__navigation-item_text'><a className='footer__navigation-item-link' href='https://practicum.yandex.com/' target='_blank' rel='noreferrer'>Practicum by Yandex</a></div>
                </li>
